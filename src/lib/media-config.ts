...
export const collectionsConfig: CollectionConfig[] = [
  {
    ...
    items: [
      ...
      { id: 339, source: "jikan" },
      { id: 232230, source: "tmdb_tv" },
      { id: 69061, source: "tmdb_tv" },
      { id: 86004, source: "tmdb_movie" },
    ],
  },
  {
    name: "Stories I Enjoyed Watching",
    items: [
      { id: 32910, source: "tmdb_tv" },
      { id: 38000, source: "jikan" },
      { id: 1100, source: "tmdb_tv" },
      { id: 99861, source: "tmdb_movie" },
      { id: 299536, source: "tmdb_movie" },
      { id: 872585, source: "tmdb_movie" },
      { id: 911430, source: "tmdb_movie" },
      { id: 335984, source: "tmdb_movie" },
      { id: 66788, source: "tmdb_tv" },
      { id: 75214, source: "tmdb_tv" },
      { id: 324857, source: "tmdb_movie" },
      { id: 372058, source: "tmdb_movie" },
      { id: 138843, source: "tmdb_movie" },
    ],
  },
  {
    name: "Rewatch Worthy",
